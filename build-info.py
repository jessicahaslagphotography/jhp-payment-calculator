  ...
  <div class="jhp-ask">
    ...
    <details name="faq">
      ...
      <div class="a">
        ...
        <p>There is a full studio client wardrobe for you to borrow from, and a
           wardrobe and styling guide comes to you by email before the day, so
           none of it is left for you to work out on your own.</p>
    ...
    <details name="faq">
      ...
      <div class="a">
        ...
        <p>Your photographs are bought separately, as a collection. Every
           client chooses one when she books, and pays for it on an
