...
<section class="jhp-sec" style="border-bottom:none">
  <div class="jhp-ask">
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>Two things you do need to bring: a nude thong and a black thong.
           Everything else is optional &mdash; hosiery, shoes and jewelry are
           welcome if you have pieces you love, but you do not need any of
           it.</p>
        <p>The rest is here. There is a full client wardrobe for you to borrow
           from, and a wardrobe and styling guide comes to you by email before
           the day, so none of it is left for you to work out on your own.</p>
        <p>If you would rather wear your own, that is completely fine &mdash;
           plenty of women do. Thistle &amp; Spire, DreamGirl, Ooh La La Cheri,
           Honey Birdette and Victoria&rsquo;s Secret are all good places to
           look.</p>
      </div>
    </details>
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>Session fees start at $697. That covers professional hair and
           makeup, access to the client wardrobe, your fully guided session,
           and your image reveal and product ordering appointment.</p>
        <p>The images and products you decide to keep are chosen at that reveal
           appointment, so they sit outside the session fee. We go through all
           of it on your consultation call, before you commit to anything. No
           surprises and no pressure &mdash; if it is not right for you, it is
           not right for you.</p>
      </div>
    </details>
