...
<section class="jhp-sec" style="border-bottom:none">
  <div class="jhp-ask">
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>You do not have to bring a thing. There is a full client wardrobe
           here for you to borrow from, and a wardrobe and styling guide comes
           to you by email before the day, so none of it is left for you to
           work out on your own.</p>
