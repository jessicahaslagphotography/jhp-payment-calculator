...
<section class="jhp-sec" style="border-bottom:none">
  <div class="jhp-ask">
    ...
    <details name="faq">
      ...
      <div class="a">
        ...
        <p>I pose you from head to toe &mdash; where your chin goes, what your
           hands are doing, where your weight sits &mdash; and I show you what
           I mean rather than describe it, so you are never left guessing. You
           will be told what to do for the whole session.</p>
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>Nobody, unless you tell me otherwise in writing.</p>
        <p>Your gallery is yours. Nothing goes on this website, on Instagram,
           or anywhere else without your written permission &mdash; and you can
           say no and still have the session. It changes nothing about how I
           photograph you. Every woman whose face is on this site said yes
           first.</p>
      </div>
    </details>
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>We plan it together before the day, on your consultation call
           &mdash; what you already own, what suits your body, and what you
           want the photographs to feel like.</p>
        <p>You do not need to go shopping to come and do this. The pieces that
           photograph best are usually simpler than women expect.</p>
      </div>
    </details>
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>Yes &mdash; professional hair and makeup is part of every session,
           done here at the studio before we shoot. You do not need to arrive
           ready, and you do not need to book it separately.</p>
      </div>
    </details>
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>Sessions start at <span class="fill">your starting figure</span>,
           and hair and makeup is included in that.</p>
        <p>We go through exactly what is and is not included on your
           consultation call, before you commit to anything. No surprises and
           no pressure &mdash; if it is not right for you, it is not right for
           you.</p>
      </div>
    </details>
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>Plan on two to three hours at the studio total for your boudoir
           experience.</p>
      </div>
    </details>
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>At your reveal, 7&ndash;14 business days after your session. We sit
           down together and go through them, and you choose the ones you want
           to keep.</p>
        <p>You are not sent a link and left to work it out alone. The reveal is
           most women&rsquo;s favourite part of the whole thing.</p>
      </div>
    </details>
    ...
    <details name="faq">
      ...
      <div class="a">
        <p>Just outside Jefferson City, Missouri. It is by appointment only, so
           the address comes to you with your booking.</p>
...
print("wrote", len(out.encode()), "bytes,",
      out.count("<details"), "questions,", out.count('class="fill"'), "blanks")
