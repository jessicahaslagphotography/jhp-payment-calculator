...
Six photographs, chosen by Jessica in the picker at /experience-picker
on 24 September. Three of them are Miss S, including the band that opens
the page and the band that closes it; two are Miss M and one is Miss A.
That is her call and it is recorded here rather than quietly changed --
the page used to run six different women precisely so it would not read
as a brochure for one client.
...
<title>What a Boudoir Session Is Like | JHP Boudoir, Missouri</title>
<meta name="description" content="Every step of a JHP Boudoir session near Jefferson City, Missouri: the studio, professional hair and makeup, the shoot itself, and your private image reveal.">
<meta name="robots" content="noindex, nofollow">
<link rel="canonical" href="https://pages.scalogy.com/jhpboudoir1/experience/">
<meta name="theme-color" content="#13100E">
<meta property="og:site_name" content="JHP Boudoir">
<meta property="og:locale" content="en_US">
<meta property="og:title" content="What a Boudoir Session Is Like | JHP Boudoir">
<meta property="og:description" content="From the first message to the album in your hands, step by step.">
<meta property="og:url" content="https://pages.scalogy.com/jhpboudoir1/experience/">
<meta property="og:image" content="https://assets.cdn.filesafe.space/Pcnm8GVNMmWTY65qVOAp/media/ae1a19f7-af39-428c-8a4b-fbc9ea507f3b.jpg">
<meta property="og:image:alt" content="A client photographed at the JHP Boudoir studio">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="What a Boudoir Session Is Like | JHP Boudoir">
<meta name="twitter:description" content="From the first message to the album in your hands, step by step.">
<meta name="twitter:image" content="https://assets.cdn.filesafe.space/Pcnm8GVNMmWTY65qVOAp/media/ae1a19f7-af39-428c-8a4b-fbc9ea507f3b.jpg">
...
/* THE REVIEW'S FRAME
   -------------------
   The shared pull-quote stands a 2:3 portrait beside the words. The frame
   Jessica chose for it is a landscape 3:2, which in that box loses 56% of
   its width, so on this page the photograph goes above the review instead
   and keeps its own shape. The words centre under it, which is what the
   shared rule already does when the two stack on a narrow screen.

   760 rather than the full 1040: a 3:2 frame the width of the text block
   would be 693px tall and the review would be below the fold of it. */
.jhp-home .jhp-quote{grid-template-columns:1fr;max-width:760px;
  gap:clamp(22px,3vw,34px);text-align:center}
.jhp-home .jhp-quote .shot::before{padding-top:66.6%}
@media (max-width:620px){
  /* The shared phone rule caps this frame to a 430px plate because a 2:3
     portrait edge to edge is a wall. A 3:2 is not: edge to edge it draws
     260px on a 390px screen, so it can simply keep its shape. */
  .jhp-home .jhp-quote .shot{height:auto}
  .jhp-home .jhp-quote .shot::before{content:"";display:block;padding-top:66.6%}
}
...
/* THE STUDIO
   ----------
   Three photographs, all of them landscape, so all three keep their own
   3:2 and nothing is cropped at all -- there is no object-position in
   this block because there is no crop to position.

   It was built the other way round: a tall frame beside two wide ones.
   Jessica picked three landscape frames, and a 3:2 photograph forced into
   that tall box loses 65% of its width -- a narrow slice out of the
   middle of a room. The shape of the section is the cheaper thing to
   change, so it changed.

   One across the top and two beneath gives the first frame the weight the
   tall one used to have, without asking any of them to be a shape they
   are not. */
.jhp-home .jhp-studio{display:grid;
  grid-template-columns:repeat(2,minmax(0,1fr));
  gap:clamp(12px,1.4vw,18px);max-width:1180px;margin:clamp(30px,4vw,46px) auto 0}
.jhp-home .jhp-studio .lead{grid-column:1 / -1}
.jhp-home .jhp-studio figure{position:relative;margin:0;min-width:0;
  overflow:hidden;background:var(--surface)}
.jhp-home .jhp-studio figure::before{content:"";display:block;padding-top:66.6%}
...
@media (max-width:820px){
  /* One column, edge to edge, which is this site's rule for photographs
     on a phone. Each frame keeps its 3:2, so the column is three rooms
     deep and none of them is cut. */
...
/* This page's bands carry different photographs from the Portfolio's, so
   ...
   The closing band is Jessica's own frame and its numbers were swept at
   1440 with the real heading on them: she stands centre-right against the
   gilt mirror, the words sit on the plant and the dark wall beside her,
   and on a phone the crop is anchored hard left to walk her further from
   them still.

   The top band is a frame I have not been able to see -- this container
   is blocked from the media CDN -- so it is centred, which is the honest
   default and not a decision. It crops 44% of its height at every width,
   and the heading is centred on the floor of it. If the words land on
   her, the vertical number here is the one line to change. */
...
@media (max-width:1024px){
  .jhp-home .jhp-intro img{height:320px;object-position:50% 50%}
  .jhp-home .jhp-intro .jhp-over{background:linear-gradient(0deg,
...
<section class="jhp-intro">
  <img src="%(cdn)sae1a19f7-af39-428c-8a4b-fbc9ea507f3b.jpg"
...
<section class="jhp-sec" style="border-bottom:none">
  ...
  <div class="jhp-studio">
    <figure class="lead">
      <img src="%(cdn)s2b4d228c-6db8-499f-b4ab-d1f82f8864d9.jpg"
           width="1600" height="1065" loading="lazy"
           alt="A client photographed at the JHP Boudoir studio">
    </figure>
    <figure>
      <img src="%(cdn)s1f13b9e2-4d0e-44be-830d-752b24c0f9ee.jpg"
           width="1600" height="1065" loading="lazy"
           alt="A client photographed at the JHP Boudoir studio">
    </figure>
    <figure>
      <img src="%(cdn)sb4a72aea-672e-4acf-a066-5d33f18b2f65.jpg"
           width="1600" height="1065" loading="lazy"
           alt="A client photographed at the JHP Boudoir studio">
    </figure>
  </div>
...
<section class="jhp-sec" style="border-bottom:none">
  <div class="jhp-quote">
    <figure class="shot">
      <img src="%(cdn)s75fa539d-9493-4c5a-8119-200b913c1d13.jpg"
           width="1600" height="1065" loading="lazy"
           alt="A boudoir photograph made at the JHP Boudoir studio">
    </figure>
    <blockquote>
...
<section class="jhp-sec" style="border-bottom:none">
  ...
  <div class="jhp-inc">
    <div class="it">
      ...
      <p>At a local salon before your session, by someone who does this for a
         living. You do not need to arrive ready and you do not need to book it
         separately &mdash; your artist and the salon address come to you once
         you book.</p>
    </div>
    <div class="it">
      <h3>The Client Wardrobe</h3>
      <p>A full wardrobe here for you to borrow from, so you are not shopping
         for something you will wear once, and a styling guide before the day.
         Bring what you love if you have it; pull from mine if you do not.</p>
    </div>
    <div class="it">
    ...
    <div class="it">
      ...
      <p>Where your chin goes, what your hands are doing, where your weight
         sits. I show you the pose myself and talk you through it, for the whole
...
<section class="jhp-sec" style="border-bottom:none">
  ...
  <ol class="jhp-flow">
    ...
    <li>
      ...
      <h3>Session Day</h3>
      <p>Hair and makeup at the salon first, then your session at the studio.
         Your session day experience will last 2&ndash;3 hours on average.</p>
    </li>
    <li>
      <span class="n" aria-hidden="true">5</span>
      <p class="when">7&ndash;14 business days later</p>
      <h3>Image Reveal</h3>
      <p>We go through your images together for the first time over Zoom,
         7&ndash;14 business days after your session. You choose which ones you
